...
public class MarketDataController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<MarketData> updateData(@PathVariable(value = "id") Long id,
                                                 @RequestBody MarketData dataDetails) {
        ...
        MarketData updatedData = marketDataService.saveData(data);
